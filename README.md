...
Bikeways_Metrics.py
This code takes the distance to bikeways csv from the Distance_to_bike_routes.py file, and calculates statistics (mean, median, standard deviation. min, max, interquartile range, and count) for each census tract.
